...
uint256 _price) public payable {
    ...
    tyepShipments.push(
        TyepShipment(msg.sender, _receiver, _pickupTime, 0, _distance, _price, ShipmentStatus.PENDING, false)
        );
    ...
    address, uint256, uint256, uint256, uint256, ShipmentStatus, bool) {
        ...
        return (shipment.sender, shipment.receiver, shipment.pickupTime, shipment.
        deliveryTime, shipment.distance, shipment.price, shipment.status, shipment.
        isPaid);
    }
